...
- **Step 21-C (slim prompt) — BLOCKED on 21-B enforce.** Requires the shadow soak + enforce flip validated first (§21.6). Do not start until `GC_ENFORCE = true` has run cleanly.
